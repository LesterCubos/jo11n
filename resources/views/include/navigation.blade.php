    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
          <a class="navbar-brand brand-logo" href="{{ route('superadmin.dashboard') }}" style="margin-top: 15px"><img src="{{ asset('img/J11White.png') }}" alt="logo" style="width: 200px; height: 70px"/></a>
          <a class="navbar-brand brand-logo-mini" href="{{ route('superadmin.dashboard') }}"><img src="{{ asset('img/J11logo.png') }}" alt="logo"/></a>
        </div>
