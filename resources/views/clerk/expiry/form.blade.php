  ...
  @endif
    ...
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card" style="border-radius: 10px">
            <div class="card-body">
              <form class="forms-sample" method="POST" action="{{ route('cremoves.store') }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="flex text-center" style="padding-top: 10px">
                    ...
                    <a href="{{ route('clerk.expiry.index')}}" class="btn btn-warning">Cancel</a>
                </div>
              </form>
            </div>
        </div>
