    ...
    <div class="card" style="border-radius: 10px">
      <div class="card-body">
        ...
        <div class="input-group col-6 search-form" style="margin-bottom: 20px; float:right">
            ...
            <input type="text" class="form-control" placeholder="Search Transactions..." wire:model.lazy="searchReceipt">
        </div>
            ...
            <tbody>
              @forelse ($trans as $tran)
                <tr>
                  ...
                  <td> 
                    <a href="/clerk/receipt{{$tran->id}}" class="btn btn-info"><i class="icon-eye"></i></a>
                  </td>
                </tr>
                @empty
                <tr>
