            ...
            <div class="form-group row">
              ...
              <div class="col-sm-9">
                <div class="search-box">
                    <input type="text" class="form-control  @error('issuesmrn') is-invalid @enderror" id="issuesmrn" name="issuesmrn" value="{{ old('issuesmrn') }}" required  wire:model="smrnSearch" wire:keyup="searchResult" placeholder="Search SMRN" >
