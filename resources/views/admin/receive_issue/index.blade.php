    ...
    <div class="card" style="border-radius: 10px; background-color: #2e9cca;">
      <div class="card-body">
        <form class="form-sample text-center">
            <a class="btn btn-info btn-icon-text" href="{{ route('admin.stocks') }}" style="margin-left: 20px; margin-right: 100px"><i class="icon-arrow-left btn-icon-prepend" style="font-size: 18px"></i>Go Back</a>
