...
@section('title','Reorder Status List')
@section('content')
...
<div class="content-wrapper" style="background-image: linear-gradient(to right, #b6fbff, #83a4d4);">
  <div class="pagetitle">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" style="font-weight: 700">Reorder List</li>
    </ol>
    </nav>
  </div><!-- End Page Title -->
  ...
  <a href="{{ route('orders.index') }}" class="btn btn-primary btn-icon-text" style="margin-bottom: 20px">
