...
@section('title','Near Stocks Minimum Level')
@section('content')
...
<div class="content-wrapper" style="background-image: linear-gradient(to right, #b6fbff, #83a4d4);">
  <div class="pagetitle">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{ route('admin.stocks') }}">Order Management</a></li>
        <li class="breadcrumb-item active" style="font-weight: 700">Notine of Near Reorder Point</li>
    </ol>
    </nav>
  </div><!-- End Page Title -->
  ...
  <a href="{{ route('admin.dashboard') }}" class="btn btn-primary btn-icon-text" style="margin-bottom: 20px">
    <i class="icon-arrow-left btn-icon-prepend"></i>
    Go Back
  </a>

  @livewire('re-order-search')
