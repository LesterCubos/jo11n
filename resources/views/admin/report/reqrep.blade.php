...
<div class="content-wrapper" style="background-image: linear-gradient(to right, #b6fbff, #83a4d4);">
    <div class="pagetitle">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" style="font-weight: 700">Request Report</li>
        </ol>
        </nav>
    </div><!-- End Page Title -->
        ...
        <div class="card" style="margin-top: 30px; bISSUE-radius: 10px; background-color: #2e9cca">
          <div class="card-body">
            <div class="d-flex align-items-center justify-content-center mb-3 text-center">
              <h4 class="card-title text-center" style="font-size: 18px; letter-spacing: 1px; font-width: bold; color: white">REQUEST REPORT</h4>
            </div>
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
