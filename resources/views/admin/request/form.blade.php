              ...
              <form class="forms-sample"method="POST" action="" enctype="multipart/form-data">
                ...
                <div class="flex text-center" style="padding-top: 10px">
                    ...
                    @if ($req->status == 'Completed')
                        <a class="btn btn-success btn-icon-text disabled" id="icon_edit" href="{{ route('requests.edit', $req->id) }}"><i class="bi bi-plus-circle-fill btn-icon-prepend"></i>Order Request</a>
                    @else
                        <a class="btn btn-success btn-icon-text" id="icon_edit" href="{{ route('requests.edit', $req->id) }}"><i class="bi bi-plus-circle-fill btn-icon-prepend"></i>Order Request</a>
                    @endif
                    
                    <a href="{{ route('requests.index') }}" class="btn btn-warning">Back</a>
                </div>
              </form>
            </div>
        </div>
